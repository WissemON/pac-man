...
class CloudTops(Level):
    """Define the cloud tops themed level."""

    def __init__(self, game: "Game", maze_grid: list[list[int]]) -> None:
        """Initialize the cloud tops.
        ...
        self.bgm_intro = resource_path(
            'music/levels/level_12/cloud_tops_intro.mp3')
        self.bgm_loop = resource_path(
            'music/levels/level_12/cloud_tops_loop.mp3')
        self.tiles = SpriteSheet(resource_path(
            'levels/level_12', 'tiles.png'), self.game)
        item_sheet = SpriteSheet(resource_path(
            'items', 'items.png'), self.game)
        self.special_item = item_sheet.get_sprite(
            79, 234, 16, 16, (192, 192, 255))

    def _load_default_enemy_skins(self) -> None:
        """Load the default enemy sprite animations."""
        enemy_sheet = SpriteSheet(resource_path(
            'enemies', 'sharks.png'), self.game)

        self.blinky = {
            'up': [
                enemy_sheet.get_sprite(51, 1, 17, 17, (255, 255, 255)),
            ],
            'down': [
                enemy_sheet.get_sprite(51, 66, 16, 20, (255, 255, 255)),
            ],
            'left': [
                enemy_sheet.get_sprite(51, 103, 17, 17, (255, 255, 255)),
            ],
            'right': [
                enemy_sheet.get_sprite(51, 35, 16, 17, (255, 255, 255)),
            ]
        }

        self.clyde = {
            'up': [
                enemy_sheet.get_sprite(0, 1, 17, 17, (255, 255, 255)),
            ],
            'down': [
                enemy_sheet.get_sprite(0, 66, 16, 20, (255, 255, 255)),
            ],
            'left': [
                enemy_sheet.get_sprite(0, 103, 17, 17, (255, 255, 255)),
            ],
            'right': [
                enemy_sheet.get_sprite(0, 35, 16, 17, (255, 255, 255)),
            ]
        }

        self.inky = {
            'up': [
                enemy_sheet.get_sprite(34, 1, 17, 17, (255, 255, 255)),
            ],
            'down': [
                enemy_sheet.get_sprite(34, 66, 16, 20, (255, 255, 255)),
            ],
            'left': [
                enemy_sheet.get_sprite(34, 103, 17, 17, (255, 255, 255)),
            ],
            'right': [
                enemy_sheet.get_sprite(34, 35, 16, 17, (255, 255, 255)),
            ]
        }

        self.pinky = {
            'up': [
                enemy_sheet.get_sprite(17, 1, 17, 17, (255, 255, 255)),
            ],
            'down': [
                enemy_sheet.get_sprite(17, 66, 16, 20, (255, 255, 255)),
            ],
            'left': [
                enemy_sheet.get_sprite(17, 103, 17, 17, (255, 255, 255)),
            ],
            'right': [
                enemy_sheet.get_sprite(17, 35, 16, 17, (255, 255, 255)),
            ]
        }
    ...
    def spawn_random_item(self) -> None:
        ...
        if free_points:
            ...
            SpecialItem(self.game, spawn_x, spawn_y, 79, 234, 16, 16)
    ...
    def _setup_maze_theme_assets(self) -> None:
        ...
        self.biomes_config = {
            'north_west': {
                'wall_base': self.tiles.get_sprite(352, 32, 16, 16),
                'ground_base': self.tiles.get_sprite(144, 288, 16, 16),
                'wall_variants': [
                    self.tiles.get_sprite(352, 32, 16, 16),
                ],
                'ground_variants': [
            ...
            'north_east': {
                'wall_base': self.tiles.get_sprite(352, 48, 16, 16),
                'ground_base': self.tiles.get_sprite(128, 288, 16, 16),
                'wall_variants': [
                    self.tiles.get_sprite(352, 48, 16, 16),
                ],
                'ground_variants': [
                    self.tiles.get_sprite(128, 288, 16, 16),
                    self.tiles.get_sprite(144, 288, 16, 16),
            ...
            'south_west': {
                'wall_base': self.tiles.get_sprite(352, 64, 16, 16),
                'ground_base': self.tiles.get_sprite(128, 288, 16, 16),
                'wall_variants': [
                    self.tiles.get_sprite(352, 64, 16, 16),
                ],
                'ground_variants': [
                    self.tiles.get_sprite(128, 288, 16, 16),
                    self.tiles.get_sprite(144, 288, 16, 16),
            ...
            'south_east': {
                'wall_base': self.tiles.get_sprite(352, 80, 16, 16),
                'ground_base': self.tiles.get_sprite(128, 288, 16, 16),
                'wall_variants': [
                    self.tiles.get_sprite(352, 80, 16, 16),
                ],
                'ground_variants': [
                    self.tiles.get_sprite(128, 288, 16, 16),
                    self.tiles.get_sprite(144, 288, 16, 16),
    ...
    def setup_decorations(self) -> None:
        ...
        step = TILE_SIZE * 2 - 7
        tree_img = self.tiles.get_sprite(98, 891, 64, 70)
    ...
    def fill_background(self, surface: pygame.Surface) -> None:
        ...
        """
        floor = self.tiles.get_sprite(16, 128, 96, 32)
