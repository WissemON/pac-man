...
class Cave(Level):
    ...
    def __init__(self, game: "Game", maze_grid: list[list[int]]) -> None:
        ...
        self.bgm_loop = resource_path('music/levels/level_09/cave_loop.mp3')
        self.tiles1 = SpriteSheet(resource_path(
            'levels/level_9', 'tiles.png'), self.game)
        sheet = SpriteSheet(resource_path(
            'items', 'power_bracelets.png'), self.game)
        self.special_item = sheet.get_sprite(0, 0, 16, 16)
    ...
    def spawn_random_item(self) -> None:
        ...
        if free_points:
            ...
            SpecialItem(self.game, spawn_x, spawn_y, 0,
                        0, 16, 16, item=self.special_item)
