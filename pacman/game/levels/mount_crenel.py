...
class MountCrenel(Level):
    """Define the mount crenel themed level."""

    def __init__(self, game: "Game", maze_grid: list[list[int]]) -> None:
        """Initialize the mount crenel.
    ...
    def spawn_random_item(self) -> None:
        ...
        if free_points:
            ...
            SpecialItem(self.game, spawn_x, spawn_y, 71, 214, 16, 16)
    ...
    def _setup_maze_theme_assets(self) -> None:
        ...
        self.biomes_config = {
            ...
            'north_east': {
                'wall_base': self.tiles.get_sprite(16, 992, 16, 16),
                'ground_base': self.tiles.get_sprite(128, 288, 16, 16),
                'wall_variants': [
                    self.tiles.get_sprite(16, 992, 16, 16),
                    self.tiles.get_sprite(32, 128, 16, 16),
            ...
            'south_east': {
                'wall_base': self.tiles.get_sprite(224, 768, 16, 16),
                'ground_base': self.tiles.get_sprite(0, 272, 16, 16),
                'wall_variants': [
                    self.tiles.get_sprite(224, 768, 16, 16),
                ],
                'ground_variants': [
    ...
    def generate_maze(self) -> None:
        ...
        water_sprite = self.tiles.get_sprite(0, 144, 16, 16)
    ...
    def fill_background(self, surface: pygame.Surface) -> None:
        ...
        """
        floor = self.tiles.get_sprite(0, 256, 16, 16)
