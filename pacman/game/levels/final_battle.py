...
class FinalBattle(Level):
    """Define the final battle themed level."""

    def __init__(self, game: "Game", maze_grid: list[list[int]]) -> None:
        """Initialize the final battle.
        ...
        self.bgm_intro = resource_path(
            'music/levels/level_16/finale_intro.mp3')
        self.bgm_loop = resource_path('music/levels/level_16/finale_loop.mp3')
        self.tiles1 = SpriteSheet(resource_path(
            'levels/level_15', 'tiles.png'), self.game)
        self.tiles2 = SpriteSheet(resource_path(
            'levels/level_16', 'tiles2.png'), self.game)
        self.tiles3 = SpriteSheet(resource_path(
            'levels/level_16', 'tiles.png'), self.game)
        item_sheet = SpriteSheet(resource_path(
            'ui', 'file_select.png'), self.game)
        self.special_item = item_sheet.get_sprite(
            53, 137, 16, 16, (167, 167, 227))

    def _load_default_enemy_skins(self) -> None:
        """Load the default enemy sprite animations."""
        enemy_sheet = SpriteSheet(resource_path(
            'enemies', 'final_battle.png'), self.game)

        self.blinky = {
            'up': [
                enemy_sheet.get_sprite(0, 0, 16, 16, (255, 255, 255)),
            ],
            'down': [
                enemy_sheet.get_sprite(0, 0, 16, 16, (255, 255, 255)),
            ],
        ...
        self.clyde = {
            'up': [
                enemy_sheet.get_sprite(36, 0, 16, 16, (255, 255, 255)),
            ],
            'down': [
                enemy_sheet.get_sprite(36, 0, 16, 16, (255, 255, 255)),
            ],
        ...
        self.inky = {
            'up': [
                enemy_sheet.get_sprite(18, 0, 16, 16, (255, 255, 255)),
            ],
            'down': [
                enemy_sheet.get_sprite(18, 0, 16, 16, (255, 255, 255)),
            ],
        ...
        self.pinky = {
            'up': [
                enemy_sheet.get_sprite(54, 0, 16, 16, (255, 255, 255)),
            ],
            'down': [
                enemy_sheet.get_sprite(54, 0, 16, 16, (255, 255, 255)),
            ],
    ...
    def spawn_random_item(self) -> None:
        ...
        if free_points:
            ...
            SpecialItem(self.game, spawn_x, spawn_y, 53, 137, 16, 16, True)
    ...
    def setup_decorations(self) -> None:
        ...
        dungeon_wall_up = self.tiles2.get_sprite(
            731, 443, 69, 74, (24, 149, 240))
        x = self.game.maze_offset_x + middle * 48
        DecorationBorder(self.game, x // 2,
    ...
    def fill_background(self, surface: pygame.Surface) -> None:
        ...
        floor = self.tiles2.get_sprite(0, 442, 256, 256)
