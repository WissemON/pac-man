...
class PalaceOfWinds(Level):
    """Define the palace of winds themed level."""

    def __init__(self, game: "Game", maze_grid: list[list[int]]) -> None:
        """Initialize the palace of winds.
        ...
        self.bgm_intro = resource_path(
            'music/levels/level_13/temple_intro.mp3')
        self.bgm_loop = resource_path('music/levels/level_13/temple_loop.mp3')
        self.tiles1 = SpriteSheet(resource_path(
            'levels/level_13', 'tiles.png'), self.game)
        self.background = SpriteSheet(resource_path(
            'items', 'backgrounds.png'), self.game)
        sheet = SpriteSheet(resource_path('items', 'items.png'), self.game)
        self.special_item = sheet.get_sprite(23, 236, 16, 16, (192, 192, 255))

    def _load_default_enemy_skins(self) -> None:
        """Load the default enemy sprite animations."""
        enemy_sheet = SpriteSheet(resource_path(
            'enemies', 'spark.png'), self.game)

        self.blinky = {
            'up': [
                enemy_sheet.get_sprite(17, 1, 16, 16, (64, 176, 136)),
            ],
            'down': [
                enemy_sheet.get_sprite(17, 1, 16, 16, (64, 176, 136)),
            ],
        ...
        self.clyde = {
            'up': [
                enemy_sheet.get_sprite(17, 55, 16, 16, (64, 176, 136)),
            ],
            'down': [
                enemy_sheet.get_sprite(17, 55, 16, 16, (64, 176, 136)),
            ],
        ...
        self.inky = {
            'up': [
                enemy_sheet.get_sprite(17, 19, 16, 16, (64, 176, 136)),
            ],
            'down': [
                enemy_sheet.get_sprite(17, 19, 16, 16, (64, 176, 136)),
            ],
        ...
        self.pinky = {
            'up': [
                enemy_sheet.get_sprite(17, 37, 16, 16, (64, 176, 136)),
            ],
            'down': [
                enemy_sheet.get_sprite(17, 37, 16, 16, (64, 176, 136)),
            ],
    ...
    def spawn_random_item(self) -> None:
        ...
        if free_points:
            ...
            SpecialItem(self.game, spawn_x, spawn_y, 23, 236, 16, 16)
    ...
    def _setup_maze_theme_assets(self) -> None:
        ...
        self.biomes_config = {
            'north_west': {
                ...
                'ground_base': self.tiles1.get_sprite(112, 1200, 16, 16),
                'wall_variants': [
                    self.tiles1.get_sprite(0, 1184, 16, 16),
                ],
                'ground_variants': [
                    self.tiles1.get_sprite(112, 1200, 16, 16),
                    self.tiles1.get_sprite(128, 1200, 16, 16),
                    self.tiles1.get_sprite(144, 1200, 16, 16),
                    self.tiles1.get_sprite(160, 1200, 16, 16),
                    self.tiles1.get_sprite(192, 1200, 16, 16),
                    self.tiles1.get_sprite(208, 1200, 16, 16),
                    self.tiles1.get_sprite(224, 1200, 16, 16),
                    self.tiles1.get_sprite(240, 1200, 16, 16),
                ]
            },
            'north_east': {
    ...
    def setup_decorations(self) -> None:
        ...
        step = TILE_SIZE * 2 - 7
        dungeon_wall_l = self.tiles1.get_sprite(352, 480, 32, 32)
        dungeon_wall_r = self.tiles1.get_sprite(192, 496, 32, 32)
    ...
    def fill_background(self, surface: pygame.Surface) -> None:
        ...
        """
        floor = self.background.get_sprite(297, 329, 256, 256)
