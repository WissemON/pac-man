...
class CastorWilds(Level):
    """Define the castor wilds themed level."""

    def __init__(self, game: "Game", maze_grid: list[list[int]]) -> None:
        """Initialize the castor wilds.
        ...
        self.bgm_intro = resource_path(
            'music/levels/level_06/castor_wilds_intro.mp3')
        self.bgm_loop = resource_path(
            'music/levels/level_06/castor_wilds_loop.mp3')
        self.tiles = SpriteSheet(resource_path(
            'levels/level_6', 'castor_wilds.png'), self.game)
    ...
    def spawn_random_item(self) -> None:
        ...
        if free_points:
            ...
            SpecialItem(self.game, spawn_x, spawn_y, 5, 236, 16, 16)
    ...
    def _setup_maze_theme_assets(self) -> None:
        ...
        self.biomes_config = {
            ...
            'north_east': {
                'wall_base': self.tiles.get_sprite(192, 448, 16, 16),
                'ground_base': self.tiles.get_sprite(64, 320, 16, 16),
                'wall_variants': [
                    self.tiles.get_sprite(192, 448, 16, 16),
                    self.tiles.get_sprite(208, 448, 16, 16),
                    self.tiles.get_sprite(224, 128, 16, 16),
                    self.tiles.get_sprite(240, 448, 16, 16),
                ],
                'ground_variants': [
                    self.tiles.get_sprite(64, 320, 16, 16),
                    self.tiles.get_sprite(80, 320, 16, 16),
                    self.tiles.get_sprite(64, 336, 16, 16),
                    self.tiles.get_sprite(80, 336, 16, 16),
                ]
            },
            'south_west': {
            ...
            'south_east': {
                'wall_base': self.tiles.get_sprite(144, 688, 16, 16),
                'ground_base': self.tiles.get_sprite(0, 272, 16, 16),
                'wall_variants': [
                    self.tiles.get_sprite(144, 688, 16, 16),
                    self.tiles.get_sprite(160, 688, 16, 16),
                ],
                'ground_variants': [
                    self.tiles.get_sprite(0, 272, 16, 16),
                ]
            }
        }
    ...
    def render_special(self, surface: pygame.Surface) -> None:
        ...
        Args:
            surface: Surface that receives drawing operations.
        """
        top_left_corner = self.tiles2.get_sprite(192, 896, 16, 16)
        top_middle = self.tiles2.get_sprite(208, 896, 16, 16)
        top_right_corner = self.tiles2.get_sprite(432, 784, 16, 16)
        left_middle = self.tiles2.get_sprite(192, 912, 16, 16)
        bottom_left_corner = self.tiles2.get_sprite(192, 928, 16, 16)
        bottom_middle = self.tiles2.get_sprite(208, 928, 16, 16)
        bottom_right_corner = self.tiles2.get_sprite(432, 928, 16, 16)
        right_middle = self.tiles2.get_sprite(880, 560, 16, 16)

        corner_left_to_bottom = self.tiles2.get_sprite(688, 656, 16, 16)
        corner_bottom_to_left = self.tiles2.get_sprite(784, 609, 16, 16)
        ...
        middle_01 = self.tiles2.get_sprite(832, 528, 16, 16)
        middle_02 = self.tiles2.get_sprite(848, 496, 16, 16)
