...
class MinishWoods(Level):
    """Define the minish woods themed level."""

    def __init__(self, game: "Game", maze_grid: list[list[int]]) -> None:
        """Initialize the minish woods.
        ...
        self.bgm_intro = resource_path(
            'music/levels/level_02/minish_woods_intro.mp3')
        self.bgm_loop = resource_path(
            'music/levels/level_02/minish_woods_loop.mp3')
        self.tiles = SpriteSheet(resource_path(
            'levels/level_2', 'minish_woods.png'), self.game)
        self.minish = SpriteSheet(resource_path(
            'levels/level_2', 'minish_woods_2.png'), self.game)
        self.mw = SpriteSheet(resource_path(
            'levels/level_2', 'minish_woods.png'), self.game)
        ...
        self.special_item = sheet.get_sprite(163, 193, 16, 16, (192, 192, 255))
    ...
    def spawn_random_item(self) -> None:
        ...
        if free_points:
            ...
            SpecialItem(self.game, spawn_x, spawn_y, 163, 193, 16, 16)
    ...
    def _setup_maze_theme_assets(self) -> None:
        ...
        self.biomes_config = {
            'north_west': {
                'wall_base': self.mw.get_sprite(16, 32, 16, 16),
                'ground_base': self.mw.get_sprite(192, 320, 16, 16),
                'wall_variants': [
                    self.mw.get_sprite(16, 32, 16, 16),
                    self.mw.get_sprite(64, 64, 16, 16),
                    self.mw.get_sprite(0, 64, 16, 16)
                ],
                'ground_variants': [
                    self.mw.get_sprite(192, 320, 16, 16),
                    self.mw.get_sprite(192, 336, 16, 16),
                    self.mw.get_sprite(192, 272, 16, 16),
                ]
            },
            'north_east': {
                'wall_base': self.mw.get_sprite(0, 128, 16, 16),
                'ground_base': self.mw.get_sprite(0, 272, 16, 16),
                'wall_variants': [
                    self.mw.get_sprite(16, 128, 16, 16),
                    self.mw.get_sprite(32, 128, 16, 16),
                    self.mw.get_sprite(48, 128, 16, 16)
                ],
                'ground_variants': [
                    self.mw.get_sprite(224, 288, 16, 16),
                    self.mw.get_sprite(224, 304, 16, 16),
                    self.mw.get_sprite(224, 320, 16, 16),
                ]
            },
            'south_west': {
                'wall_base': self.mw.get_sprite(16, 48, 16, 16),
                'ground_base': self.mw.get_sprite(0, 48, 16, 16),
                'wall_variants': [
                    self.mw.get_sprite(48, 144, 16, 16),
                    self.mw.get_sprite(0, 144, 16, 16),
                    self.mw.get_sprite(336, 178, 16, 16),
                ],
                'ground_variants': [
                    self.mw.get_sprite(32, 304, 16, 16),
                    self.mw.get_sprite(48, 304, 16, 16),
                    self.mw.get_sprite(64, 256, 16, 16),
                ]
            },
            'south_east': {
                'wall_base': self.mw.get_sprite(64, 128, 16, 16),
                'ground_base': self.mw.get_sprite(160, 512, 16, 16),
                'wall_variants': [
                    self.mw.get_sprite(64, 144, 16, 16),
                    self.mw.get_sprite(64, 128, 16, 16)
                ],
                'ground_variants': [
                    self.mw.get_sprite(176, 525, 16, 16),
                    self.mw.get_sprite(192, 525, 16, 16),
                    self.mw.get_sprite(176, 544, 16, 16),
                ]
            }
        }
    ...
    def setup_decorations(self) -> None:
        ...
        step = TILE_SIZE * 2 - 7
        tree_img = self.minish.get_sprite(898, 512, 64, 62)
    ...
    def fill_background(self, surface: pygame.Surface) -> None:
        ...
        """
        floor = self.tiles.get_sprite(224, 400, 16, 16)
    ...
    def render_special(self, surface: pygame.Surface) -> None:
        ...
        # on sait il y a combien de 15 pour dessiner 42 on dessine sur l'ordre
        fifty_index = 0
        for y, maze_row in enumerate(self.maze_grid):
            for x, cell in enumerate(maze_row):
