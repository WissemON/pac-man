...
class TempleDroplets(Level):
    """Define the temple droplets themed level."""

    def __init__(self, game: "Game", maze_grid: list[list[int]]) -> None:
        """Initialize the temple droplets.
        ...
        self.bgm_loop = resource_path('music/levels/level_10/temple_loop.mp3')
        self.tiles1 = SpriteSheet(resource_path(
            'levels/level_10', 'tiles.png'), self.game)
        sheet = SpriteSheet(resource_path('items', 'items.png'), self.game)
        self.special_item = sheet.get_sprite(54, 214, 16, 16, (192, 192, 255))
    ...
    def spawn_random_item(self) -> None:
        ...
        if free_points:
            ...
            SpecialItem(self.game, spawn_x, spawn_y, 54, 214, 16, 16)
    ...
    def _setup_maze_theme_assets(self) -> None:
        ...
        self.biomes_config = {
            'north_west': {
                'wall_base': self.tiles1.get_sprite(0, 1184, 16, 16),
                'ground_base': self.tiles1.get_sprite(64, 1248, 16, 16),
                'wall_variants': [
                    self.tiles1.get_sprite(0, 1184, 16, 16),
                ],
                'ground_variants': [
                    self.tiles1.get_sprite(64, 1248, 16, 16),
                    self.tiles1.get_sprite(80, 1248, 16, 16),
                ]
            },
            'north_east': {
            ...
            'south_west': {
                ...
                'ground_variants': [
                    ...
                    self.tiles1.get_sprite(64, 80, 16, 16),
                ]
            },
            'south_east': {
                'wall_base': self.tiles1.get_sprite(384, 240, 16, 16),
                'ground_base': self.tiles1.get_sprite(240, 0, 16, 16),
                'wall_variants': [
                    self.tiles1.get_sprite(384, 240, 16, 16),
                ],
                'ground_variants': [
                    self.tiles1.get_sprite(240, 0, 16, 16),
                    self.tiles1.get_sprite(320, 80, 16, 16),
                ]
            }
        }
    ...
    def generate_maze(self) -> None:
        ...
        water_sprite = self.tiles1.get_sprite(0, 816, 16, 16)
        ...
        Bridge(self.game, x + 16, walk_y,
               self.tiles1.get_sprite(160, 623, 16, 16))
        Water(self.game, x + 16, walk_y + TILE_SIZE,
              self.tiles1.get_sprite(160, 608, 16, 16))
    ...
    def setup_decorations(self) -> None:
        ...
        step = TILE_SIZE * 2 - 7
        dungeon_wall_l = self.tiles1.get_sprite(160, 272, 32, 48)
        dungeon_wall_r = self.tiles1.get_sprite(192, 272, 32, 48)
    ...
    def fill_background(self, surface: pygame.Surface) -> None:
        ...
        """
        floor = self.tiles1.get_sprite(0, 800, 16, 16)
    ...
    def render_special(self, surface: pygame.Surface) -> None:
        ...
        Args:
            surface: Surface that receives drawing operations.
        """
        top_left_corner = self.tiles1.get_sprite(416, 1488, 16, 16)
        top_middle = self.tiles1.get_sprite(416, 1472, 16, 16)
        top_right_corner = self.tiles1.get_sprite(432, 1488, 16, 16)
        left_middle = self.tiles1.get_sprite(448, 1472, 16, 16)
        bottom_left_corner = self.tiles1.get_sprite(416, 1504, 16, 16)
        bottom_middle = self.tiles1.get_sprite(432, 1472, 16, 16)
        bottom_right_corner = self.tiles1.get_sprite(432, 1504, 16, 16)
        right_middle = self.tiles1.get_sprite(464, 1472, 16, 16)

        corner_left_to_bottom = self.tiles1.get_sprite(464, 1488, 16, 16)
        corner_bottom_to_left = self.tiles1.get_sprite(464, 1504, 16, 16)
        ...
        middle_02 = self.tiles1.get_sprite(352, 1456, 16, 16)
