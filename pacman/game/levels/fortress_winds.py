...
class FortressWinds(Level):
    """Define the fortress winds themed level."""

    def __init__(self, game: "Game", maze_grid: list[list[int]]) -> None:
        """Initialize the fortress winds.
        ...
        self.bgm_intro = resource_path(
            'music/levels/level_08/fortress_winds.mp3')
        self.bgm_loop = resource_path(
            'music/levels/level_08/fortress_winds_loop.mp3')
        self.tiles1 = SpriteSheet(resource_path(
            'levels/level_8', 'tiles.png'), self.game)
        self.tiles2 = SpriteSheet(resource_path(
            'levels/level_7', 'tiles1.png'), self.game)
        sheet = SpriteSheet(resource_path('items', 'items.png'), self.game)
        self.special_item = sheet.get_sprite(37, 214, 16, 16, (192, 192, 255))

    def _load_default_enemy_skins(self) -> None:
        """Load the default enemy sprite animations."""
        enemy_sheet = SpriteSheet(resource_path(
            'enemies', 'skulls.png'), self.game)

        self.blinky = {
            'up': [
                enemy_sheet.get_sprite(0, 0, 15, 15, (0, 0, 0)),
            ...
            'left': [
                enemy_sheet.get_sprite(129, 0, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(144, 0, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(161, 0, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(176, 0, 14, 16, (0, 0, 0)),
            ],
            'right': [
                enemy_sheet.get_sprite(193, 0, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(210, 0, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(225, 0, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(242, 0, 14, 16, (0, 0, 0)),
            ]
        }

        self.clyde = {
            'up': [
                enemy_sheet.get_sprite(0, 48, 15, 15, (0, 0, 0)),
            ...
            'left': [
                enemy_sheet.get_sprite(129, 48, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(144, 48, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(161, 48, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(176, 48, 14, 16, (0, 0, 0)),
            ],
            'right': [
                enemy_sheet.get_sprite(193, 48, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(210, 48, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(225, 48, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(242, 48, 14, 16, (0, 0, 0)),
            ]
        }

        self.inky = {
            'up': [
                enemy_sheet.get_sprite(0, 97, 15, 15, (0, 0, 0)),
                enemy_sheet.get_sprite(16, 97, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(32, 97, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(48, 97, 15, 16, (0, 0, 0)),
            ],
            'down': [
                enemy_sheet.get_sprite(64, 97, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(80, 97, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(96, 97, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(112, 97, 15, 16, (0, 0, 0)),
            ],
            'left': [
                enemy_sheet.get_sprite(129, 97, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(144, 97, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(161, 97, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(176, 97, 14, 16, (0, 0, 0)),
            ],
            'right': [
                enemy_sheet.get_sprite(193, 97, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(210, 97, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(225, 97, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(242, 97, 14, 16, (0, 0, 0)),
            ]
        }

        self.pinky = {
            'up': [
                enemy_sheet.get_sprite(0, 144, 15, 15, (0, 0, 0)),
                enemy_sheet.get_sprite(16, 144, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(32, 144, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(48, 144, 15, 16, (0, 0, 0)),
            ],
            'down': [
                enemy_sheet.get_sprite(64, 144, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(80, 144, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(96, 144, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(112, 144, 15, 16, (0, 0, 0)),
            ],
            'left': [
                enemy_sheet.get_sprite(129, 144, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(144, 144, 15, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(161, 144, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(176, 144, 14, 16, (0, 0, 0)),
            ],
            'right': [
                enemy_sheet.get_sprite(193, 144, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(210, 144, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(225, 144, 14, 16, (0, 0, 0)),
                enemy_sheet.get_sprite(242, 144, 14, 16, (0, 0, 0)),
            ]
        }
    ...
    def spawn_random_item(self) -> None:
        ...
        if free_points:
            ...
            SpecialItem(self.game, spawn_x, spawn_y, 37, 214, 16, 16)
    ...
    def _setup_maze_theme_assets(self) -> None:
        ...
        self.biomes_config = {
            'north_west': {
                'wall_base': self.tiles1.get_sprite(320, 1888, 16, 16),
                'ground_base': self.tiles2.get_sprite(480, 1648, 16, 16),
                'wall_variants': [
                    self.tiles2.get_sprite(320, 1888, 16, 16),
                    self.tiles2.get_sprite(336, 1888, 16, 16),
                    self.tiles2.get_sprite(352, 1888, 16, 16)
                ],
                'ground_variants': [
                    self.tiles2.get_sprite(480, 1648, 16, 16),
                    self.tiles2.get_sprite(496, 1648, 16, 16),
                    self.tiles2.get_sprite(480, 1664, 16, 16),
                    self.tiles2.get_sprite(496, 1664, 16, 16),
                ]
            },
            'north_east': {
            ...
            'south_west': {
                'wall_base': self.tiles1.get_sprite(160, 240, 16, 16),
                'ground_base': self.tiles1.get_sprite(160, 112, 16, 16),
                'wall_variants': [
                    self.tiles1.get_sprite(160, 240, 16, 16),
                    self.tiles1.get_sprite(176, 240, 16, 16),
                ],
                'ground_variants': [
                    self.tiles1.get_sprite(160, 112, 16, 16),
                    self.tiles1.get_sprite(160, 128, 16, 16),
                ]
            },
            'south_east': {
                'wall_base': self.tiles1.get_sprite(384, 240, 16, 16),
                'ground_base': self.tiles1.get_sprite(384, 192, 16, 16),
                'wall_variants': [
                    self.tiles1.get_sprite(384, 240, 16, 16),
                ],
                'ground_variants': [
                    self.tiles1.get_sprite(384, 192, 16, 16),
                    self.tiles1.get_sprite(400, 192, 16, 16),
                    self.tiles1.get_sprite(416, 192, 16, 16),
                    self.tiles1.get_sprite(432, 192, 16, 16),
                    self.tiles1.get_sprite(384, 208, 16, 16),
                    self.tiles1.get_sprite(400, 208, 16, 16),
                    self.tiles1.get_sprite(416, 208, 16, 16),
                    self.tiles1.get_sprite(432, 208, 16, 16),
                ]
            }
        }
    ...
    def generate_maze(self) -> None:
        ...
        self.game.player = Player(self.game, player_x, player_y, 'red')
        self.game.player.current_held_item = self.special_item

        tunnel_row = len(self.maze_grid) // 2
        self.tunnels = {
            'left': (0, tunnel_row), 'right': (len(self.maze_grid[0]) - 1,
                                               tunnel_row)
        }

        water_sprite = self.tiles1.get_sprite(320, 80, 16, 16)
        bridge_sprite = self.tiles1.get_sprite(144, 816, 16, 16)
    ...
    def setup_decorations(self) -> None:
        ...
        step = TILE_SIZE * 2 - 7
        dungeon_wall_l = self.tiles1.get_sprite(0, 336, 32, 48)
        dungeon_wall_r = self.tiles1.get_sprite(32, 336, 32, 48)

        left_x = self.game.maze_offset_x - 48
        right_x = self.game.maze_offset_x + self.game.maze_width + 48
        for r in range(0, rows + 15, 1):
            y = self.game.maze_offset_y + r * step + step - 16
            DecorationBorder(self.game, left_x, y - 16, dungeon_wall_l)
            DecorationBorder(self.game, right_x, y - 16, dungeon_wall_r)

        dungeon_wall_up = self.tiles1.get_sprite(0, 272, 48, 32)
        dungeon_wall_down = self.tiles1.get_sprite(0, 304, 48, 32)
        for c in range(0, cols + 7, 1):
            x = self.game.maze_offset_x + c * step + step - 16
    ...
    def setup_gums(self, nb_pac_gums: int) -> None:
        ...
        for x, y in corners:
            if (x, y) in reserved:
                world_x, world_y = self._grid_to_world_center(x, y)
                SuperPacGum(self.game, world_x, world_y, 38, 194, 16, 16)
    ...
    def fill_background(self, surface: pygame.Surface) -> None:
        ...
        """
        floor = self.tiles1.get_sprite(496, 160, 16, 16)
    ...
    def render_special(self, surface: pygame.Surface) -> None:
        ...
        Args:
            surface: Surface that receives drawing operations.
        """
        top_left_corner = self.tiles1.get_sprite(368, 1488, 16, 16)
        top_middle = self.tiles1.get_sprite(352, 1552, 16, 16)
        top_right_corner = self.tiles1.get_sprite(384, 1488, 16, 16)
        left_middle = self.tiles1.get_sprite(416, 1504, 16, 16)
        bottom_left_corner = self.tiles1.get_sprite(368, 1504, 16, 16)
        bottom_middle = self.tiles1.get_sprite(352, 1456, 16, 16)
        bottom_right_corner = self.tiles1.get_sprite(384, 1504, 16, 16)
        right_middle = self.tiles1.get_sprite(320, 1504, 16, 16)

        corner_left_to_bottom = self.tiles1.get_sprite(320, 1456, 16, 16)
        corner_bottom_to_left = self.tiles1.get_sprite(320, 1552, 16, 16)
        ...
        middle_01 = self.tiles1.get_sprite(288, 1456, 16, 16)
        middle_02 = self.tiles1.get_sprite(288, 1456, 16, 16)
